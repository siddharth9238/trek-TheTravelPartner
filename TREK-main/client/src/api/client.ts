...
import {
  ...
  type AiChatRequest, type AiItineraryRequest, type AiItineraryResponse,
  type AiPackingRequest, type AiPackingResponse,
  type AiExpenseAnalysisRequest, type AiExpenseAnalysisResponse,
  type AiDestinationRequest, type AiDestinationResponse,
  type AiTripSummaryRequest, type AiTripSummaryResponse,
  type SearchFlightDto, type FlightSearchResponse,
  type SearchHotelDto, type HotelSearchResponse,
  type SearchTaxiDto, type TaxiResult,
  type SearchCarDto, type RentalCar,
} from '@trek/shared'
...
export const apiClient: AxiosInstance = axios.create({
  // Because /api is here, ALL endpoints below automatically get prefixed with /api/
  baseURL: `${API_URL}/api`, 
...
export const authApi = {
  ...
  // GUEST LOGIN & LOGOUT (Merged cleanly)
  guestLogin: () => apiClient.post('/auth/guest').then(r => r.data),
...
export const flightsApi = {
  search: (dto: SearchFlightDto): Promise<FlightSearchResponse> =>
    apiClient.get('/flights/search', { params: dto }).then(r => r.data),
}

export const hotelsApi = {
  search: (dto: SearchHotelDto): Promise<HotelSearchResponse> =>
    apiClient.get('/hotels/search', { params: dto }).then(r => r.data),
}

export const taxiApi = {
  search: (dto: SearchTaxiDto): Promise<TaxiResult[]> =>
    apiClient.get('/taxi/search', { params: dto }).then(r => r.data),
}

export const carsApi = {
  search: (dto: SearchCarDto): Promise<RentalCar[]> =>
    apiClient.get('/car/search', { params: dto }).then(r => r.data),
}
...
export const aiApi = {
  ...
  generatePackingList: (data: AiPackingRequest): Promise<AiPackingResponse> =>
    apiClient.post('/ai/packing', data).then(r => r.data),
  analyzeExpenses: (data: AiExpenseAnalysisRequest): Promise<AiExpenseAnalysisResponse> =>
    apiClient.post('/ai/analyze-expenses', data).then(r => r.data),
  recommendDestinations: (data: AiDestinationRequest): Promise<AiDestinationResponse> =>
    apiClient.post('/ai/recommend-destinations', data).then(r => r.data),
  generateTripSummary: (data: AiTripSummaryRequest): Promise<AiTripSummaryResponse> =>
    apiClient.post('/ai/trip-summary', data).then(r => r.data),
}
