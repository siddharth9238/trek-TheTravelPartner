...
export const SYSTEM_NOTICES: SystemNotice[] = [
  ...
  // `recurring: 'per-version'` re-surfaces it whenever the app version moves up.
  {
    ...
    highlights: [
      { labelKey: 'system_notice.thank_you_support.highlight_opensource', iconName: 'Code' },
    ...
    cta: {
      kind: 'link',
      labelKey: 'system_notice.thank_you_support.cta_linkedin',
      href: 'https://www.linkedin.com/in/siddharth-singh-3241b8241',
    },
    secondaryCta: {
      kind: 'link',
      labelKey: 'system_notice.thank_you_support.cta_portfolio',
