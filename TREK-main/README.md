...
# TREK - The Travel Partner

TREK is a comprehensive travel companion application designed to simplify flight and hotel discovery.

## Key Features
- **Real-time Flight Search:** Compare flight routes, schedules, and pricing directly.
- **Smart Booking Links:** Integrated deep-linking functionality that redirects users to Google Flights and Booking.com with specific search criteria pre-filled.
- **Hotel Discovery:** Search for global accommodations with live availability, detailed ratings, and pricing.
- **Trip Management:** Organize your travel itineraries with secure data handling.

## Tech Stack
- **Frontend:** React, Vite, Tailwind CSS
- **Backend:** NestJS
- **APIs:** RapidAPI (AeroDataBox for Flights, Booking.com for Hotels)
